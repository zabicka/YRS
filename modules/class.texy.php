 ...
 * @link       http://texy.info
 * @package    Texy
 * @version    $Id: texy.php 226 2008-12-31 00:16:35Z David Grudl $
 */
...
// Texy! libraries
require_once dirname(__FILE__) . '/texy/libs/RegExp.Patterns.php';
require_once dirname(__FILE__) . '/texy/libs/TexyObject.php';
require_once dirname(__FILE__) . '/texy/libs/TexyHtml.php';
require_once dirname(__FILE__) . '/texy/libs/TexyModifier.php';
require_once dirname(__FILE__) . '/texy/libs/TexyModule.php';
require_once dirname(__FILE__) . '/texy/libs/TexyParser.php';
require_once dirname(__FILE__) . '/texy/libs/TexyUtf.php';
require_once dirname(__FILE__) . '/texy/libs/TexyConfigurator.php';
require_once dirname(__FILE__) . '/texy/libs/TexyHandlerInvocation.php';
...
class Texy extends TexyObject
{
	...
	const REVISION = '226 released on 2008/12/31 01:16:35';
	...
	public function setOutputMode($mode)
	{
		...
		if (!isset(self::$dtdCache[$mode])) {
			require dirname(__FILE__) . '/texy/libs/DTD.php';
