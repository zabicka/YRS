<?php //netteloader=IDibiVariable,IDataSource,IDibiProfiler,IDibiDriver,DibiObject,DibiException,DibiDriverException,DibiConnection,DibiResult,DibiRow,DibiResultIterator,DibiTranslator,DibiVariable,DibiTableX,DibiTable,DibiDataSource,DibiFluent,DibiDatabaseInfo,DibiTableInfo,DibiColumnInfo,DibiForeignKeyInfo,DibiIndexInfo,DibiProfiler,dibi,DibiMySqlDriver,DibiMySqliDriver,DibiOdbcDriver,DibiPdoDriver,DibiPostgreDriver,DibiSqliteDriver
 ...
 * @package    dibi
 * @version    1.01 (revision 183 released on 2009/01/13 03:55:02)
 */
...
function
__wakeup(){$this->setFlags(2);}}class
DibiResultIterator
implements
...
implode(', ',$vx);case'sql':$translator=new
self($this->driver);$translator->translate($value);return$translator->sql;default:foreach($value
...
static
function
detectType($type){static$patterns=array('BYTE|COUNTER|SERIAL|INT|LONG'=>dibi::FIELD_INTEGER,'CURRENCY|REAL|MONEY|FLOAT|DOUBLE|DECIMAL|NUMERIC|NUMBER'=>dibi::FIELD_FLOAT,'^TIME$'=>dibi::FIELD_TIME,'TIME'=>dibi::FIELD_DATETIME,'YEAR|DATE'=>dibi::FIELD_DATE,'BYTEA|BLOB|BIN'=>dibi::FIELD_BINARY,'BOOL|BIT'=>dibi::FIELD_BOOL);if(!isset(self::$types[$type])){self::$types[$type]=dibi::FIELD_TEXT;foreach($patterns
...
IDENTIFIER='n';const
VERSION='1.01';const
REVISION='183 released on 2009/01/13 03:55:02';const
